...
$cat = $_GET['rowid'];
  ...
  $designer = mysqli_query($connect, "SELECT * FROM designer JOIN images WHERE id_d=id_designer AND category='$cat' order by id_image desc");
      ...
      <div class="container">
          ...
          while($data = mysqli_fetch_array($designer))
              ...
              <a href="tampilan_portofolio_d.php?p_id=<?php echo $data['title']?>&id=<?php echo $data['id_d']?>" class="portfolio-link">
                      ...
                      <?php
                      echo "<td><img src='uploads/".$data['image']."'  class='img-responsive' alt=''></td>";
                      ?>
                  ...
                  <div class="portfolio-caption">
                      ...
                      <p class="text-muted">
                      Designer: <a href="profil_designer_designerpov.php?rowid=<?php echo $data['id_d'] ?>"> <?php echo $data['first_name'];?> <?php echo $data['last_name'];?></a>
                  </div>
