...
$query = mysqli_query($connect, "SELECT * FROM images order by id_image desc");
  ...
  <div class="container-fluid">
    <div class="navbar-collapse collapse in">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li class="navbar-title">Uploaded Portofolio</li>
      </ul>
                     ...
                     <div class="col-md-4 col-sm-6 portfolio-item">
                      <a class="portfolio-link">
                          ...
                          <div class="portfolio-caption">
                              <?php echo $data['title'];?>
                              <a href="deleteimage1.php?id_image=<?php echo $data['id_image']?>">delete</a>
                          </div>
                      </div>
                      <?php
                      }
