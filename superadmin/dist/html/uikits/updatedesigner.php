<?php 
    ...
    $idpost = $_GET['id_c'];
    $query = mysqli_query($connect,"SELECT * FROM designer WHERE id_d = '$idpost'");
...
if($_POST) {
  ...
  $sql = "UPDATE designer SET username = '$username', first_name = '$fname', last_name = '$lname', email = '$email', contact = '$contact' WHERE id_d = '$idpost'";
              ...
              <tbody>
                  <tr>
                      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                                    ...
                                    <input type="text" class="form-control" name="contact" value="<?php echo $data['contact']; ?>" required><br>
