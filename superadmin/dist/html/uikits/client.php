      ...
      <div class="container-fluid">
        <div class="navbar-collapse collapse in">
          ...
          <ul class="nav navbar-nav navbar-left">
            <li class="navbar-title">Clients</li>
      ...
      <div class="card">
        ...
        <div class="card-body no-padding">
          <table class="datatable table table-striped primary" cellspacing="0" width="100%">
              ...
              <tbody>
              <?php while($data = mysqli_fetch_array($client)){?>
                  <tr>
                      ...
                      <td>
                        <div>
                          <a href="updateclient.php?id_c=<?php echo $data['id']?>">
                          Edit
                          </a>
                        </div>
                      </td>
                      <td>
                                <a href="deleteclient.php?id_c=<?php echo $data['id']?>">delete</a></td>
                  <tr>
                  <?php
                  }
                  ?>
